...
if __name__ == '__main__':
    ...
    X = np.loadtxt('../../data/driftDatasets/artificial/chess/transientChessboard.data')
    y = np.loadtxt('../../data/driftDatasets/artificial/chess/transientChessboard.labels', dtype=np.uint8)
